...
<aside class="hospital-sidebar" :class="{ 'collapsed': sidebarCollapsed, 'open': sidebarOpen }">
    ...
    <nav class="hospital-sidebar-nav">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" 
           class="hospital-nav-item <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>"
        ...
        <div class="hospital-nav-section">
            ...
            <a href="#" 
               class="hospital-nav-item <?php echo e(request()->is('diagnosticos*') ? 'active' : ''); ?>"
        ...
        <div class="hospital-nav-section">
            ...
            <a href="#" 
               class="hospital-nav-item <?php echo e(request()->is('unidades*') ? 'active' : ''); ?>">
                <svg class="hospital-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="#" 
               class="hospital-nav-item <?php echo e(request()->is('setores*') ? 'active' : ''); ?>">
                <svg class="hospital-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="hospital-nav-section">
            ...
            <a href="#" 
               class="hospital-nav-item <?php echo e(request()->is('relatorios*') ? 'active' : ''); ?>">
                <svg class="hospital-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="hospital-nav-section">
            ...
            <a href="#" 
               class="hospital-nav-item <?php echo e(request()->is('configuracoes*') ? 'active' : ''); ?>">
                <svg class="hospital-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-3 pt-3 border-t border-gray-200">
                <div class="text-xs text-gray-600">
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium text-gray-900"><?php echo e(\App\Models\User::count()); ?></span>
                    </div>
                    ...
                    <div class="flex justify-between mt-1">
                        ...
                        <span class="font-medium text-gray-900"><?php echo e(now()->format('H:i')); ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="px-4 py-3 border-t border-gray-200">
        <div class="text-center" :class="{ 'opacity-0 hidden': sidebarCollapsed }">
            <div class="text-xs text-gray-500">
                ...
                <p class="mt-1">© <?php echo e(date('Y')); ?> EMSERH</p>
                <p class="mt-1">Laravel <?php echo e(app()->version()); ?></p>
            </div>
        </div>
...
</style><?php /**PATH C:\projects\qualidade\sistema-qualidade\resources\views/layouts/partials/sidebar.blade.php ENDPATH**/ ?>