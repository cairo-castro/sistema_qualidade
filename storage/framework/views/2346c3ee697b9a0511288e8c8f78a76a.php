<div class="flex items-center justify-between w-full">
    ...
    <div class="flex items-center space-x-3">
        ...
        <div class="hidden lg:flex items-center space-x-2">
            ...
            <button class="gqa-btn ghost" onclick="toggleHospitalTheme()">
        ...
        <div class="relative" x-data="{ open: false }">
            <button @click="open = !open" 
                ...
                <div class="w-8 h-8 rounded-full overflow-hidden border-2 border-white dark:border-gray-600 shadow-md">
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&background=22c55e&color=fff&size=32" 
                         alt="<?php echo e(Auth::user()->name); ?>" 
                         class="w-full h-full object-cover" />
                </div>
                <div class="hidden md:block text-left">
                    <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e(Auth::user()->name); ?></p>
                    <p class="text-xs text-gray-600 dark:text-gray-300"><?php echo e(Auth::user()->email); ?></p>
                </div>
            ...
            <div x-show="open" 
                ...
                <div class="p-4 border-b border-gray-200 dark:border-gray-600 bg-gradient-to-r from-green-50 to-blue-50 dark:from-gray-700 dark:to-gray-600">
                    <div class="flex items-center space-x-3">
                        <div class="w-12 h-12 rounded-full overflow-hidden border-2 border-white dark:border-gray-500 shadow-md">
                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&background=22c55e&color=fff&size=48" 
                                 alt="<?php echo e(Auth::user()->name); ?>" 
                                 class="w-full h-full object-cover" />
                        </div>
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900 dark:text-white truncate"><?php echo e(Auth::user()->name); ?></p>
                            <p class="text-sm text-gray-600 dark:text-gray-300 truncate"><?php echo e(Auth::user()->email); ?></p>
                            <?php if(Auth::user()->getRoleNames()->isNotEmpty()): ?>
                                <div class="mt-1">
                                    <span class="gqa-badge primary"><?php echo e(Auth::user()->getRoleNames()->first()); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="py-2">
                    ...
                    <a href="<?php echo e($profileEditUrl); ?>" 
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view diagnosticos')): ?>
                    <a href="#" 
                       class="gqa-dropdown-item flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 w-full transition-colors">
                        <svg class="w-4 h-4 mr-3 text-gray-400 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-3 border-t border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700">
                    <div class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                        <span>Sessão: <?php echo e(substr(session()->getId(), 0, 8)); ?>...</span>
...
</script><?php /**PATH C:\projects\qualidade\sistema-qualidade\resources\views/layouts/partials/navbar.blade.php ENDPATH**/ ?>