...
<?php $__env->startSection('title', 'Gerenciar Papéis'); ?>
...
<div class="hospital-content">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create roles')): ?>
                <a href="<?php echo e(route('admin.roles.create')); ?>" class="hospital-btn hospital-btn-primary">
    ...
    <div class="gqa-card mb-6">
        ...
        <form method="GET" action="<?php echo e(route('admin.roles.index')); ?>" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
                ...
                <select class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100" 
                    ...
                    <option value="users_count" <?php echo e(request('sort_by') == 'users_count' ? 'selected' : ''); ?>>Nº Usuários</option>
                    <option value="created_at" <?php echo e(request('sort_by') == 'created_at' ? 'selected' : ''); ?>>Data Criação</option>
                </select>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php if($roles->count() > 0): ?>
                ...
                <div class="gqa-card group hover:shadow-lg transition-all duration-200">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center">
                            <div class="w-10 h-10 rounded-lg flex items-center justify-center mr-3
                                <?php echo e($role->name == 'Admin' ? 'bg-red-100 dark:bg-red-900/20' : 
                                   ($role->name == 'Gestor' ? 'bg-yellow-100 dark:bg-yellow-900/20' : 
                                    'bg-blue-100 dark:bg-blue-900/20')); ?>">
                                <svg class="w-5 h-5 
                                    <?php echo e($role->name == 'Admin' ? 'text-red-600 dark:text-red-400' : 
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100"><?php echo e($role->name); ?></h3>
                        </div>
                        ...
                        <div class="relative">
                            <button type="button" 
                                    ...
                                    onclick="toggleRoleDropdown('<?php echo e($role->id); ?>')">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"></path>
                                </svg>
                            </button>
                            
                            <div id="roleDropdown<?php echo e($role->id); ?>" class="hidden absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-10">
                                <div class="py-1">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create roles')): ?>
                                        <a href="<?php echo e(route('admin.roles.clone', $role)); ?>" 
                                           class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div class="text-center">
                            <div class="text-2xl font-bold text-green-600 dark:text-green-400"><?php echo e($role->users_count); ?></div>
                            <div class="text-sm text-gray-600 dark:text-gray-400">Usuários</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-blue-600 dark:text-blue-400"><?php echo e($role->permissions->count()); ?></div>
                            ...
                            <div class="flex flex-wrap gap-1">
                                ...
                                <?php if($role->permissions->count() > 3): ?>
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400">
                                        +<?php echo e($role->permissions->count() - 3); ?> mais
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php else: ?>            <div class="col-span-full">
    ...
    <div class="gqa-card mt-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="text-center">
                <div class="text-2xl font-bold text-green-600 dark:text-green-400"><?php echo e($roles->total()); ?></div>
                <div class="text-sm text-gray-600 dark:text-gray-400">Total de Papéis</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-blue-600 dark:text-blue-400"><?php echo e($roles->sum('users_count')); ?></div>
                <div class="text-sm text-gray-600 dark:text-gray-400">Usuários com Papéis</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-purple-600 dark:text-purple-400">
                    <?php echo e($roles->avg('users_count') ? number_format($roles->avg('users_count'), 1) : '0'); ?>
            ...
            <div class="text-center">
                <div class="text-2xl font-bold text-orange-600 dark:text-orange-400">
                    <?php echo e($roles->sum(function($role) { return $role->permissions->count(); })); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\qualidade\sistema-qualidade\resources\views/admin/roles/index.blade.php ENDPATH**/ ?>