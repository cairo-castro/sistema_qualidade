    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                <a href="<?php echo e(route('admin.users.show', $user)); ?>" class="hospital-btn hospital-btn-outline-primary">
        ...
        <form method="POST" action="<?php echo e(route('admin.users.update', $user)); ?>" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="email" 
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" 
                               class="w-full px-3 py-2 pr-10 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                    ...
                    <?php if($roles->count() > 0): ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="relative">
                                    <label class="flex items-center p-3 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors <?php echo e($user->id == auth()->id() && $role->name == 'Admin' ? 'opacity-50' : ''); ?>">
                                        <input type="checkbox" 
                                               value="<?php echo e($role->id); ?>" 
                                               name="roles[]" 
                                               <?php echo e(in_array($role->id, old('roles', $userRoles)) ? 'checked' : ''); ?>

                                               <?php echo e($user->id == auth()->id() && $role->name == 'Admin' ? 'disabled' : ''); ?>

                                               class="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded">
                                        <div class="ml-3 flex-1">
                                            <div class="flex items-center">
                                                <span class="px-2 py-1 text-xs font-medium rounded-full <?php echo e($role->name == 'Admin' ? 'bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-400' : ($role->name == 'Gestor' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400' : 'bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400')); ?>">
                                                    <?php echo e($role->name); ?>

                                                </span>
                                            </div>
                                            <?php if($user->id == auth()->id() && $role->name == 'Admin'): ?>
                                            ...
                                            <?php if($role->permissions->count() > 0): ?>
                                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e($role->permissions->count()); ?> permissões</p>
                                            <?php endif; ?>
                                        </div>
                                    </label>
                                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="gqa-card">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="text-gray-900 dark:text-gray-100 font-medium"><?php echo e($user->created_at->format('d/m/Y H:i:s')); ?></div>
                    </div>
                    <div>
                        <div class="text-sm text-gray-600 dark:text-gray-400">Última atualização</div>
                        <div class="text-gray-900 dark:text-gray-100 font-medium"><?php echo e($user->updated_at->format('d/m/Y H:i:s')); ?></div>
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <?php if($user->email_verified_at): ?>
                            <div class="flex items-center text-green-600 dark:text-green-400 font-medium">
                                ...
                                Verificado em <?php echo e($user->email_verified_at->format('d/m/Y H:i:s')); ?>
            ...
            <div class="flex justify-between pt-6 border-t border-gray-200 dark:border-gray-700">
                <a href="<?php echo e(route('admin.users.index')); ?>" class="hospital-btn hospital-btn-outline-secondary">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projects\qualidade\sistema-qualidade\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>