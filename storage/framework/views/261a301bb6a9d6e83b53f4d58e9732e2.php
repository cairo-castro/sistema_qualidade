...
<head>
    ...
    <title><?php echo e($title ?? 'Dashboard'); ?> - <?php echo e(config('app.name', 'Sistema GQA')); ?></title>
    ...
    ?>
     <?php if($hasCustomTheme): ?>
    <style id="user-theme-styles">
        :root {
            <?php if($userTheme['navbar_color']): ?>
                --custom-navbar-bg: <?php echo e($userTheme['navbar_color']); ?>;
                --custom-navbar-text: <?php echo e(\App\Helpers\ThemeHelper::getContrastingTextColor($userTheme['navbar_color'])); ?>;
            <?php endif; ?>
            <?php if($userTheme['sidebar_color']): ?>
                --custom-sidebar-bg: <?php echo e($userTheme['sidebar_color']); ?>;
                --custom-sidebar-text: <?php echo e(\App\Helpers\ThemeHelper::getContrastingTextColor($userTheme['sidebar_color'])); ?>;
            <?php endif; ?>
            <?php if($userTheme['background_color']): ?>
                --custom-background: <?php echo e($userTheme['background_color']); ?>;
                --custom-background-text: <?php echo e(\App\Helpers\ThemeHelper::getContrastingTextColor($userTheme['background_color'])); ?>;
            <?php endif; ?>
        }
        ...
        .hospital-navbar .gqa-btn:hover {
            <?php if($userTheme['navbar_color']): ?>
                ...
                ?>
                background-color: <?php echo e($hoverBg); ?> !important;
            <?php endif; ?>
        }
        ...
        .hospital-content [class*="card"] {
            <?php if($userTheme['background_color']): ?>
                ...
                ?>
                background-color: <?php echo e($cardBg); ?> !important;
                color: <?php echo e($cardText); ?> !important;
                border: 1px solid <?php echo e($cardBorder); ?> !important;
                box-shadow: 0 4px 6px -1px <?php echo e($cardShadow); ?>, 0 2px 4px -1px rgba(0,0,0,0.06) !important;
            <?php endif; ?>
        }
        ...
        .hospital-navbar [class*="badge"] {
            <?php if($userTheme['navbar_color']): ?>
                ...
                ?>
                background-color: <?php echo e($badgeBg); ?> !important;
                color: <?php echo e($badgeText); ?> !important;
                border-color: <?php echo e($badgeText); ?> !important;
            <?php endif; ?>
        }
        ...
        .hospital-navbar .animate-pulse.bg-green-500 {
            <?php if($userTheme['navbar_color']): ?>
                ...
                ?>
                background-color: <?php echo e($indicatorColor); ?> !important;
            <?php endif; ?>
        }
        ...
        [class*="badge"]:not(.hospital-navbar *):not(.hospital-sidebar *) {
            <?php if($userTheme['background_color']): ?>
                ...
                background-color: <?php echo e($badgeBg); ?> !important;
                color: <?php echo e($badgeText); ?> !important;
                border-color: <?php echo e($badgeBorder); ?> !important;
            <?php endif; ?>
        }
    ...
    <script>
        window.userTheme = <?php echo json_encode($userTheme, 15, 512) ?>;
        window.hasCustomTheme = <?php echo json_encode($hasCustomTheme, 15, 512) ?>;
    </script>
    ...
    <div class="hospital-layout">
        ...
        <main class="hospital-main" :class="{ 'sidebar-collapsed': sidebarCollapsed }">
            ...
            <div class="hospital-content">
                <!-- Breadcrumb -->
                <?php if(isset($breadcrumbs) || isset($title)): ?>
                    ...
                    <div class="gqa-alert warning mb-6 hospital-fade-in-up" data-auto-hide>
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-yellow-700 mt-1"><?php echo e(session('warning')); ?></p>
                            </div>
                            <div class="ml-auto pl-3">
                    ...
                    <div class="gqa-alert info mb-6 hospital-fade-in-up" data-auto-hide>
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-blue-700 mt-1"><?php echo e(session('info')); ?></p>
                            </div>
                            <div class="ml-auto pl-3">
...
<?php /**PATH C:\projects\qualidade\sistema-qualidade\resources\views/layouts/app.blade.php ENDPATH**/ ?>