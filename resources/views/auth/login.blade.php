    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" 
                   name="name" 
                   value="{{ old('name') }}" 
                   class="w-full px-4 py-3 rounded-lg border transition-all duration-200 focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50 @error('name') border-red-500 @else border-slate-300 dark:border-slate-600 @enderror bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 placeholder-slate-500 dark:placeholder-slate-400 focus:border-primary-500 dark:focus:border-primary-400" 
        ...
        <div>
            ...
            <div class="relative" x-data="{ show: false }">
                <input :type="show ? 'text' : 'password'" 
                       name="password" 
                       class="w-full px-4 py-3 rounded-lg border transition-all duration-200 focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50 @error('password') border-red-500 @else border-slate-300 dark:border-slate-600 @enderror bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 placeholder-slate-500 dark:placeholder-slate-400 focus:border-primary-500 dark:focus:border-primary-400" 
                       placeholder="••••••••"
                       required 
